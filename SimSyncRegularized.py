...
def SimSyncReg(N, edges, pointclouds, scale_gt=None, Weights = None, reg_lambda=1):
    ...
    with mosek.Task() as task:
        ...
        if (solsta == mosek.solsta.optimal):
            ...
            # f_est = sr_est.T @ np.kron(C, np.eye(3)) @ sr_est + reg_lambda*np.linalg.norm((s_est**2-1))**2
